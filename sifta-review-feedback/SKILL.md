...
description: >
    ...
    把某人移入顾问/推荐人/产业标杆，排除候选人类型，或希望下一轮保留约束和本轮覆盖缺口
    时使用。
    普通总结、推荐名单美化或无上一轮结果的新搜索不要使用；新搜索应回到 `sifta-search` 路由。
---
...
5. 把候选人迁移到通过、排除、顾问/推荐人、产业标杆、已知人脉或待确认线索等状态。
...
| 方向对但证据弱     | 保留为待确认线索；增加个人资料、职业经历和项目证据要求     |
