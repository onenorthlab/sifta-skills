...
```bash
sifta-cli find-people --query "AI GTM 出海营销 增长 商业化 developer marketing AI 产品" \
...
```bash
sifta-cli find-people --query "AI developer marketing 社区增长 DevRel GTM 开源产品" \
...
sifta-cli find-people \
  --query "AI video creator tool GTM 增长 商业化 中国市场 北美市场候选人，来自 AI video、AI animation、AI avatar 或 creator tool 相邻公司" \
