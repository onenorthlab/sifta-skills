...
| 创始人型 / operator | source-map lead / profile lead | 产品页、GitHub、LinkedIn、公开公司资料 | X/社区、媒体、融资/发布记录、用户反馈 | 个人资料 + 0 到 1 作品/团队/用户/增长证据 | 通常先走主能力路径，再决定 CLI |
| 超级个体 / 独立开发者 | source-map lead / profile lead | 个人主页、产品页、GitHub、公开作品 | X、Hugging Face、ModelScope、知乎、即刻、公众号、B 站 | 个人资料 + 公开作品 + 技术/产品/分发证据 | 通常由宿主 Agent 建来源地图 |
