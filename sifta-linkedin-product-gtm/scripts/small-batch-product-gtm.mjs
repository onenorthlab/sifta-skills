...
function outputBlocked(reason, nextAction) {
	process.stdout.write(
		[
			...
			"| --- | --- | --- | --- | --- | --- | --- |",
			"| 暂无推荐 | - | 不产全职候选 | 本轮连接器未形成候选人 | 低 | 需要先恢复连接器；未恢复前只保留来源线索和标杆 | - |",
			"",
			"待确认线索",
			"",
			"| 线索 | 为什么相关 | 还差什么 | 下一步怎么确认 |",
			"| --- | --- | --- | --- |",
			"| LinkedIn 连接器 | Product/GTM 方向需要公开职业资料 | 连接器不可用 | 检查认证；未恢复前只做标杆/来源线索，不包装全职候选 |",
			"",
			"匹配依据",
			"",
			...
			"为什么先停在这里",
			"",
			"- 连接器不可用时不能用网页、Exa、浏览器或手写 LinkedIn 查询替换候选人，也不能把 fallback 摘要包装成全职、strong 或 soft 候选。",
			"",
			"本轮边界",
			"",
